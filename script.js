function carregaDicionario(){
    ...
    for(var bio in biografias){
        ...
        '<details><summmary>'+biografias[bio].nome+'</summary><p>'+
        biografias[bio].descricao+'</p>'+
        '<blockquote><q>'+ biografias[bio].citacao +'</q></blockquote></details></div>';
        };
};
